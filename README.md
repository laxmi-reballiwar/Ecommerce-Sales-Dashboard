...
An interactive Ecommerce Sales Dashboard built using Power BI to analyze key business metrics such as sales, profit, customer behavior, and product performance.
...
- Payment modes and regional data (City, State) 
...
- Analyzed category-wise performance to understand product demand  
